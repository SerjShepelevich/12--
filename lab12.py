...
temp = Lab12('Python', list_of_skills)
result = temp.number_pages
dic_ = temp.harvest_vac()
list_salary = temp.calculate_mid_salary_list()
dict_skills = temp.top_skills()

print("Средняя зарплата по Москва программиста Python = ",sum(list_salary)/len(list_salary))
print("Максимальная сумма по ЗП = ",max(list_salary))
print("Минимальная сумма по ЗП = ",min(list_salary))
print("Часто встречающиеся навыки:")
pprint.pprint(dict_skills)

#Средняя зарплата по Москва программиста Python =  145891.67578125
#Максимальная сумма по ЗП =  469868
#Минимальная сумма по ЗП =  60701
